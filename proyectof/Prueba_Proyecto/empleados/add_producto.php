...
<body>
	...
	<div class="container">
		<div class="content">
			<h2>Datos de Productos &raquo; Agregar Productos</h2>
			<hr />
			...
			if (isset($_POST['add_producto'])) {
				...
				if (mysqli_num_rows($cek) == 0) {
					$insert = mysqli_query($con, "INSERT INTO producto(codigo, nombres, cantidad, valor, tipo_producto)
						VALUES('$codigo','$nombres', '$cantidad', '$valor', '$tipo_producto')") or die($mysqli->connect_error);
					if ($insert) {
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<textarea name="valor" class="form-control" placeholder="Valor"></textarea>
					</div>
				</div>

				<div class="form-group">
					<label class="col-sm-3 control-label">Tipo_Producto</label>
					<div class="col-sm-3">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="submit" name="add_producto" class="btn btn-sm btn-primary" value="Guardar datos">
						<a href="index_producto.php" class="btn btn-sm btn-danger">Cancelar</a>
					</div>
				</div>
			</form>
		</div>
